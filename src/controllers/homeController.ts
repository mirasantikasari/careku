...
export const updateHomeData = async (uid: string, refreshToken: string, data: Partial<HomeData>) => {
...
const logDailyMetrics = async (uid: string, refreshToken: string, data: Partial<HomeData>) => {
